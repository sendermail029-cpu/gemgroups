...
With plot sizes ranging from 165 to 440 sq yards, Sree Laxmi Balaji Township caters to diverse investment needs — from first-time buyers seeking an accessible entry point to seasoned investors looking for premium land parcels.`,
    ...
    amenities: [
      { icon: '🏛️', name: 'Grand Clubhouse -30,000 Sq Ft', description: 'Premium recreation & community hall' },
      ...
      { icon: '🛣️', name: '33ft Wide Roads', description: 'Asphalted internal roads throughout' },
  ...
  { src: '/images/gal4.jpg', alt: 'Investment land', category: 'plots' },
    ...
    nearbyPlaces: [
      ...
      { name: 'Shadnagar Town Muncipilites', distance: '0 km', category: 'other' },
      { name: 'Hyderabad International Airport', distance: '35 km', category: 'airport' },
      { name: 'Microsoft Data Center', distance: '3 km', category: 'highway' },
      { name: 'National Remote Sensing Centre (NRSC) ', distance: '0 km', category: 'school' },
      { name: 'Amazon Ware House', distance: '10 km', category: 'hospital' },
    ],
